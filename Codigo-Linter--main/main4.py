...
class MyWindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.layout.pack_start(scrolled_window, True, True, 0)
    ...
    def on_check_button_clicked(self, button):
        ...
        # markup = f'<span size="xx-large" weight="bold" foreground="blue">{result.upper()}</span>'
        self.result_label.set_markup(
            f'<span foreground="blue" size="large" weight="bold" font-desc="Sans 12">{result.upper()}</span>'
        )
